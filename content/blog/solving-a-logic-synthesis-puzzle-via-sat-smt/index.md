...
In other words, if there were a solution with $x_3=f_3(x_2,x_1)$, we would also find it with $x_3=f_3(x_1, x_2)$ but the interpretation of $f_3$ <q>mirrored</q>.
...
### Implementation
Since [the implementation](gen_sat.py) is mostly a refinement of the SMT instance generator, I will only touch on some aspects and refer to the implementation for details.
...
Although a SAT-based characterisation is a lot larger than its SMT-based counterpart, it is less complex and is typically solved in orders-of-magnitude less time.
